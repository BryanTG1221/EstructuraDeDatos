...
namespace ArbolBinarioBusqueda
{
    public partial class Form1 : Form
    {
        ...
        public void AgregarNodosFiltrados()
        {
        ...
        private void btnLlenarMenore_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                foreach (ClaseRoja Persona in ArbolBianario.FiltrarDatos(ObjetoInteligente))
                {
                    dtgMenores.Rows.Add(Persona.Edad, Persona.Puesto, Persona.HomeOffice, Persona.Salario);
                }
